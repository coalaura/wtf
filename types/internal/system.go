...
func init() {
	...
	types.RegisterSignature(types.KindSystemdJournal, types.TypeNone, 0, []byte("LPKSHR"))
	...
	types.RegisterSignature(types.KindWindowsApplicationLog, types.TypeNone, 0, []byte("{\x0d\x0a\x6f\x20"))
	...
	types.RegisterSignature(types.KindWindowsHelp, types.TypeLN, 0, []byte("LN\x02\x00"))
