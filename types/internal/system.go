...
func init() {
	...
	types.RegisterSignature(types.KindBinHex, types.TypeNone, 11, []byte("must be converted with BinHex 4.0"))
	...
	types.RegisterSignature(types.KindBlender, types.TypeNone, 0, []byte("BLENDER"))
	...
	types.RegisterSignature(types.KindWindowsHibernation, types.TypeNone, 0, []byte("hibr"))
