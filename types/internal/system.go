...
func init() {
	...
	types.RegisterSignature(types.KindRetroArchSavestate, types.TypeNone, 0, []byte("RST\x00"))
	...
	types.RegisterSignature(types.KindSnes9xSavestate, types.TypeNone, 0, []byte("#!s9xsnp"))
	...
	types.RegisterSignature(types.KindVBScriptEncodedScript, types.TypeNone, 0, []byte("#@~^"))
	types.RegisterSignature(types.KindVisualBoyAdvanceSavestate, types.TypeNone, 0, []byte("VBA "))
	...
	types.RegisterSignature(types.KindWindowsShortcutLink, types.TypeNone, 0, []byte{0x4c, 0x00, 0x00, 0x00, 0x01, 0x14, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0xc0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x46})
	...
	types.RegisterSignature(types.KindXPCOMTypeLibrary, types.TypeNone, 0, []byte("XPCOM\nTy"))
	types.RegisterSignature(types.KindZSNESSavestate, types.TypeNone, 0, []byte("ZSNES Save State File"))
	...
	types.RegisterWeakSignature(types.KindMSDOSCOFFObject, types.TypeCOFFObject, 0, []byte{0x4c, 0x01})
