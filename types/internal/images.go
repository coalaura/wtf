...
func init() {
	...
	types.RegisterSignature(types.KindApplePICTImage, types.TypeNone, 522, []byte{0x00, 0x11, 0x02, 0xff})
	...
	types.RegisterSignature(types.KindCALSRasterImage, types.TypeNone, 0, []byte("srcdocid:"))
	types.RegisterSignature(types.KindCanonRAWImage, types.TypeHE, 0, []byte{'I', 'I', 0x1a, 0x00, 0x00, 0x00, 'H', 'E'})
	types.RegisterSignature(types.KindChromaGraphImage, types.TypeNone, 0, []byte("PICT\x00\x08"))
	types.RegisterSignature(types.KindCineonImage, types.TypeNone, 0, []byte{0x80, 0x2a, 0x5f, 0xd7})
	types.RegisterSignature(types.KindClipStudioPaintImage, types.TypeNone, 0, []byte("CSFCHUNK"))
	...
	types.RegisterSignature(types.KindDesignTools2DDrawing, types.TypeNone, 0, []byte("dt2ddtd"))
	types.RegisterSignature(types.KindDesignTools2DDrawing, types.TypeNone, 0, []byte{0x07, 0x64, 0x74, 0x32, 0x64, 0x64, 0x74, 0x64})
	...
	types.RegisterSignature(types.KindEasyStreetDrawDrawing, types.TypeNone, 0, []byte{0x7e, 0x45, 0x53, 0x44, 0x77, 0xf6, 0x85, 0x3e, 0xbf, 0x6a, 0xd2, 0x11, 0x45, 0x61, 0x73, 0x79, 0x20, 0x53, 0x74, 0x72, 0x65, 0x65, 0x74, 0x20, 0x44, 0x72, 0x61, 0x77})
	types.RegisterSignature(types.KindECWImage, types.TypeNone, 0, []byte("ECW\x00"))
	...
	types.RegisterSignature(types.KindGLTFBinaryModel, types.TypeNone, 0, []byte("glTF"))
	...
	types.RegisterSignature(types.KindIFFContainer, types.TypeCatalog, 0, []byte("CAT "))
	types.RegisterSignature(types.KindIFFContainer, types.TypeList, 0, []byte("LIST"))
	types.RegisterSignature(types.KindImgSoftwareImage, types.TypeNone, 0, []byte("SCMI"))
	...
	types.RegisterSignature(types.KindKodakPhotoCD, types.TypeNone, 2048, []byte("PCD_IPI"))
	types.RegisterSignature(types.KindKTXTextureImage, types.TypeVersion1, 0, []byte{0xab, 'K', 'T', 'X', ' ', '1', '1', 0xbb, 0x0d, 0x0a, 0x1a, 0x0a})
	types.RegisterSignature(types.KindKTXTextureImage, types.TypeVersion2, 0, []byte{0xab, 'K', 'T', 'X', ' ', '2', '0', 0xbb, 0x0d, 0x0a, 0x1a, 0x0a})
	types.RegisterSignature(types.KindLytroLightFieldImage, types.TypeNone, 0, []byte("\x89LFP\x0d\x0a\x1a\x0a"))
	types.RegisterSignature(types.KindMacPaintImage, types.TypeNone, 65, []byte("PNTG"))
	types.RegisterSignature(types.KindMagicaVoxelModel, types.TypeNone, 0, []byte("VOX "))
	...
	types.RegisterSignature(types.KindPaintDotNetImage, types.TypeNone, 0, []byte("PDN3"))
	...
	types.RegisterSignature(types.KindPaintToolSAIImage, types.TypeNone, 0, []byte("SAI\x00"))
	types.RegisterSignature(types.KindPAXImage, types.TypeNone, 0, []byte("PAX"))
	types.RegisterSignature(types.KindPCXDCXImage, types.TypeNone, 0, []byte{0xb1, 0x68, 0xde, 0x3a})
	...
	types.RegisterSignature(types.KindPhotoshopDocument, types.TypeLargeDocument, 0, []byte("8BPB"))
	types.RegisterSignature(types.KindPhotoshopDocument, types.TypeNone, 0, []byte("8BPS"))
	types.RegisterSignature(types.KindPNGImage, types.TypeNone, 0, []byte{137, 'P', 'N', 'G', 13, 10, 26, 10})
	types.RegisterSignature(types.KindPVRTextureImage, types.TypeNone, 0, []byte("PVR\x03"))
	...
	types.RegisterSignature(types.KindSoftimagePIC, types.TypeNone, 0, []byte{0x53, 0x80, 0xf6, 0x34})
	types.RegisterSignature(types.KindSPIFFImage, types.TypeNone, 0, []byte{0xff, 0xd8, 0xff, 0xe8, 0x00, 0x1e, 0x53, 0x50, 0x49, 0x46, 0x46, 0x00})
	...
	types.RegisterSignature(types.KindValveTextureFormatImage, types.TypeNone, 0, []byte("VTF\x00"))
	types.RegisterSignature(types.KindWindowsCursorImage, types.TypeNone, 0, []byte{0x00, 0x00, 0x02, 0x00})
	types.RegisterSignature(types.KindWindowsIconImage, types.TypeNone, 0, []byte{0x00, 0x00, 0x01, 0x00})
	types.RegisterSignature(types.KindWindowsThumbnailCache, types.TypeIMMMFormat, 0, []byte("IMMM\x15\x00\x00\x00"))
