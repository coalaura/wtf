...
func init() {
	...
	types.RegisterSignature(types.KindAvidDNxHD, types.TypeNone, 0, []byte{0x00, 0x00, 0x02, 0x80, 0x01})
	...
	types.RegisterSignature(types.KindIdSoftwareRoQVideo, types.TypeNone, 0, []byte{0x84, 0x10, 0xff, 0xff})
	types.RegisterSignature(types.KindInterplayMVEVideo, types.TypeNone, 0, []byte("Interplay MVE File\x1a\x00\x00\x00"))
	...
	types.RegisterSignature(types.KindNintendoTHPVideo, types.TypeNone, 0, []byte("THP\x00"))
	...
	types.RegisterSignature(types.KindRealMediaContainer, types.TypeNone, 0, []byte{'.', 'R', 'M', 'F'})
	...
	types.RegisterSignature(types.KindRiveAnimation, types.TypeNone, 0, []byte("RIVE"))
	...
	types.RegisterSignature(types.KindVideoCDImage, types.TypeNone, 0, []byte("ENTRYVCD"))
	...
	types.RegisterMaskedSignature(types.KindIFFContainer, types.TypeWestwoodVQA, 0, []byte("FORM\x00\x00\x00\x00WVQA"), []byte{0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff})
