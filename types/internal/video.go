...
func init() {
	...
	types.RegisterSignature(types.KindISOBaseMedia, types.TypeQuickTimeMovie, 4, []byte("free"))
	types.RegisterSignature(types.KindISOBaseMedia, types.TypeQuickTimeMovie, 4, []byte("mdat"))
	types.RegisterSignature(types.KindISOBaseMedia, types.TypeQuickTimeMovie, 4, []byte("moov"))
	types.RegisterSignature(types.KindISOBaseMedia, types.TypeQuickTimeMovie, 4, []byte("pnot"))
	types.RegisterSignature(types.KindISOBaseMedia, types.TypeQuickTimeMovie, 4, []byte("skip"))
	types.RegisterSignature(types.KindISOBaseMedia, types.TypeQuickTimeMovie, 4, []byte("wide"))
	...
	types.RegisterSignature(types.KindVideoVCD, types.TypeNone, 0, []byte("ENTRYVCD"))
	types.RegisterSignature(types.KindWebexARF, types.TypeNone, 0, []byte{0x01, 0x00, 0x02, 0x00})
